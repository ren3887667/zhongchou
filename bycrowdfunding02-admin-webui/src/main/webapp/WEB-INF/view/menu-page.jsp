...
<script type="text/javascript" src="http://127.0.0.1:8321/crowd/my-menu.js"></script>
...
<%@ include file="/WEB-INF/view/menu-top.jsp"%>
<div class="container-fluid">
    <div class="row">

       <%@ include file="/WEB-INF/view/menu-left.jsp"%>
...
<%@include file="/WEB-INF/view/modal-menu-add.jsp" %>
<%@include file="/WEB-INF/view/modal-menu-confirm.jsp" %>
<%@include file="/WEB-INF/view/modal-menu-edit.jsp" %>
