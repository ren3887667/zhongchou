...
public class Generator  {
    ...
    public static void main(String[] args) {
        ...
        mpg.setGlobalConfig(new GlobalConfig()
                ...
                .setFileOverride(true).setOutputDir("G://daima//zhongchou1//bycrowdfunding03-admin-component//src//main//java")
        ...
        mpg.setDataSource(new DataSourceConfig()
                ...
                .setUrl("jdbc:mysql://169.254.49.228:3306/project_crowd?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai")
        );
